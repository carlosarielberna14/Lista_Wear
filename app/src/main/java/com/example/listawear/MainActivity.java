...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new ItemsList(R.drawable.jesus, "Jesúcristro", "Curso de Jesúcristo"));
        items.add(new ItemsList(R.drawable.virgen_maria, "Virgencita", "Curso de la Virgencita"));
        items.add(new ItemsList(R.drawable.seta, "Seta", "Curso de Seta"));
        items.add(new ItemsList(R.drawable.planta_carnivora, "Biologia", "Curso de Biologia"));
        items.add(new ItemsList(R.drawable.squirtle, "Pokemon", "Curso de Pokemon"));
